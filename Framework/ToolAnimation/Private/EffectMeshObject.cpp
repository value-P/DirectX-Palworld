...
shared_ptr<CEffectMeshObject> ToolAnimation::CEffectMeshObject::Create(const shared_ptr<FGameObjectDesc>& _spGameObjectDesc, FEffectMeshInfo _tEffectMeshInfo)
{
...
shared_ptr<CEffectMeshObject> ToolAnimation::CEffectMeshObject::CreateFromJson(const shared_ptr<FGameObjectDesc>& _spGameObjectDesc, const wstring& _wstrJsonFileName)
{
	shared_ptr<CEffectMeshObject> spInstance = make_shared<CEffectMeshObject>();
	CHECKF(spInstance, L"CEffectObject : Create Failed");
...
HRESULT ToolAnimation::CEffectMeshObject::Initialize(const shared_ptr<FGameObjectDesc>& _spGameObjectDesc)
{
...
HRESULT ToolAnimation::CEffectMeshObject::InitializeFromJson(const shared_ptr<FGameObjectDesc>& _spGameObjectDesc, const wstring& _wstrJsonFileName)
{
	if (FAILED(CEffectBase::Initialize(_spGameObjectDesc))) { return E_FAIL; }
...
HRESULT ToolAnimation::CEffectMeshObject::BeginPlay()
{
...
int32 ToolAnimation::CEffectMeshObject::PreTick(float _fDeltaSeconds)
{
...
int32 ToolAnimation::CEffectMeshObject::Tick(float _fDeltaSeconds)
{
...
int32 ToolAnimation::CEffectMeshObject::PostTick(float _fDeltaSeconds)
{
...
HRESULT ToolAnimation::CEffectMeshObject::EndPlay()
{
...
void ToolAnimation::CEffectMeshObject::Release()
{
	CEffectBase::Release();
}

void ToolAnimation::CEffectMeshObject::RecycleFromPool()
{
}

void ToolAnimation::CEffectMeshObject::NoneActivate()
{
}

void ToolAnimation::CEffectMeshObject::EndLifeTime()
{
}

void ToolAnimation::CEffectMeshObject::Loop()
{
}

uint32 ToolAnimation::CEffectMeshObject::GetCurKeyFrameIndex()
{
	return m_spEffectMesh->GetCurKeyFrameIndex();
}

std::vector<FEffectMeshKeyFrame>& ToolAnimation::CEffectMeshObject::GetKeyFrames()
{
