...
std::shared_ptr<ToolAnimation::CInstanceEffectMeshObject> ToolAnimation::CInstanceEffectMeshObject::Create(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc, FEffectMeshInfo _tEffectMeshInfo, FInstanceEffectMeshInfo _tInstanceEffectMeshInfo)
{
...
shared_ptr<ToolAnimation::CInstanceEffectMeshObject> ToolAnimation::CInstanceEffectMeshObject::CreateFromJson(const shared_ptr<FGameObjectDesc>& _spGameObjectDesc, const wstring& _wstrJsonFileName)
{
	shared_ptr<CInstanceEffectMeshObject> spInstance = make_shared<CInstanceEffectMeshObject>();
	CHECKF(spInstance, L"CInstanceEffectMeshObject : Create Failed");
...
HRESULT ToolAnimation::CInstanceEffectMeshObject::Initialize(const shared_ptr<FGameObjectDesc>& _spGameObjectDesc)
{
...
HRESULT ToolAnimation::CInstanceEffectMeshObject::InitializeFromJson(const shared_ptr<FGameObjectDesc>& _spGameObjectDesc, const wstring& _wstrJsonFileName)
{
	if (FAILED(CEffectBase::Initialize(_spGameObjectDesc))) { return E_FAIL; }
...
HRESULT ToolAnimation::CInstanceEffectMeshObject::BeginPlay()
{
...
int32 ToolAnimation::CInstanceEffectMeshObject::PreTick(float _fDeltaSeconds)
{
...
int32 ToolAnimation::CInstanceEffectMeshObject::Tick(float _fDeltaSeconds)
{
...
int32 ToolAnimation::CInstanceEffectMeshObject::PostTick(float _fDeltaSeconds)
{
...
HRESULT ToolAnimation::CInstanceEffectMeshObject::EndPlay()
{
...
void ToolAnimation::CInstanceEffectMeshObject::Release()
{
	CEffectBase::Release();
}

uint32 ToolAnimation::CInstanceEffectMeshObject::GetCurKeyFrameIndex()
{
	return m_spInstanceEffectMesh->GetCurKeyFrameIndex();
}

std::vector<FEffectMeshKeyFrame>& ToolAnimation::CInstanceEffectMeshObject::GetKeyFrames()
{
